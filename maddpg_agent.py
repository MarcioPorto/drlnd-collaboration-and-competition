    ...
    def __init__(self, action_size, state_size, device, lr_actor, lr_critic,
        ...
        for _ in range(self.num_agents):
            self.maddpg_agents.append(
                DDPGAgent(in_actor=state_size, hidden_in_actor=600, hidden_out_actor=400, out_actor=action_size, 
                          in_critic=state_size, hidden_in_critic=600, hidden_out_critic=400,
